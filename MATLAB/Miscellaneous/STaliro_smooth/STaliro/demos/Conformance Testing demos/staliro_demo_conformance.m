...
currentdir = pwd;
if isempty(regexp(currentdir,'demos\\ver1_5$'))
...
pause(2)
addpath('../../benchmarks/NavBenchmark', '../../benchmarks/AutomaticTransmission', '../../benchmarks/Powertrain')
init.loc = 13;
...
ImplementationSys = @BlackBoxPowertrain03;
opt.black_box = 1;
