...
hold on;
plot(x_0(1),x_0(2),'m*','MarkerSize',10,'LineWidth',2);
hold on;
plot(x(1),x(2),'kp','MarkerSize',10,'LineWidth',2);
hold on;
plot(2.5,2.5,'g+','MarkerSize',10,'LineWidth',2);

for i = 1:size(x_samples,2)
   hold on;
   plot(x_samples(1,i),x_samples(2,i),'o');
end
