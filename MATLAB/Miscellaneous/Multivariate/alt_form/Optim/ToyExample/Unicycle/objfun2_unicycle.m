function [f,g] = objfun2_unicycle(x,optParams)
...
% GRADIENT INDEXING NEEDS TO BE REDONE, this is not 1:40, but [1 2 nope,
% yep yep nope, yep yep nope mode ...]
if(nargout>1)
...
g_temp = zeros(optParams.dim_x*optParams.len,1);
P = [];
...
f1 = 0;f2=0;rob=0;g_temp = zeros(optParams.dim_x*optParams.len,1);
end
...
g(1:optParams.dim_x*optParams.len) = -g_temp+2*x(1:optParams.dim_x*optParams.len)*optParams.gamma; %FIX!!!!
