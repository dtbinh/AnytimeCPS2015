...
%  for i = 1:N-1
%      events(i,1) = i*dT;
%      events(i,2) = hoverThrust+input_1(1,i);
%      events(i,3) = 0; %yaw
%      events(i,4) = rad2deg(input_1(2,i));
%      events(i,4) = rad2deg(input_1(3,i));
%      
%  end
...
quad1 = Quad(2,2,2,0,0,0);
% quad 2
quad2 = Quad(2,-2,2,0,0,0);
