...
r_phi(7) = robustness_always_notP(pos1,optParams.wavparams.NoFly,0);
r_phi(8) = robustness_always_notP(pos2,optParams.wavparams.NoFly,0);
r_phi(9) = robustness_always_SafeDist([pos1;pos2],optParams.d_min,0);
