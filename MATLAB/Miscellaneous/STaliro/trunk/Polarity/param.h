...
mxArray *monitor(Node *phi, PMap *predMap, double *XTrace, double *TStamps, double *LTrace, DistCompData *p_distData, FWTaliroParam *param, Miscellaneous *miscell);

void DPRob(Node *subformula[], double *next, double *now, DistCompData *p_distData, Number *pct, Number *pdt, char *plast, FWTaliroParam *p_par, int jjj, int ii, int jj, Number *CurTime, HyDis *TempL, HyDis *TempR);
