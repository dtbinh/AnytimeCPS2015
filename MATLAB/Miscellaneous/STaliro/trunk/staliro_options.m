...
%       6. 'YourFunctionName' : You may define a custom cost function  
%                with a name defined as you like and with the following 
%                interface: rob = YourFunctionName(x, t, customCostAuxData) 
%                where x and t are the state and timing vectors, and 
%                auxData is any data you need for the function. 
%                auxData is set through staliro_options, i.e. 
%                   opt = staliro_options; opt.customCostAuxData = anyData;      
%                Note that your custom function has to be in the path.
%
...
%
% opt.customCostAuxData = [];
%   This option lets the user provide any data needed in their custom cost
%   function. 
%
...
% (C) 2015, Adel Dokhanchi, Arizona State University
    ...
    properties
        ...
        input_constraints_function = 'none';
        input_A = [];
        input_b = [];
        customCostAuxData = [];
    end
