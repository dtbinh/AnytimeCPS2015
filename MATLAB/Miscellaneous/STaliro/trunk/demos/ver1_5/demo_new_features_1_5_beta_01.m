% This is a demo for using the new features in S-TALIRO 1.5 beta
% 
...
% (C) B. Hoxha 2013 - Arizona State Univeristy
...
disp('      * save intermmediate results')
disp('      * undersample output signals')
