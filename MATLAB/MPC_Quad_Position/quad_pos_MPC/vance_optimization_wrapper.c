...
void load_default_data(void) {
  ...
  params.B[16] = 0;
  params.B[17] = 0.05;
  params.u_limit[0] = 0.52;
  params.u_limit[1] = 0.52;
  params.u_limit[2] = 10;
 ...
 *
 */
void vance_optimization_Outputs_wrapper(real_T *theta,
			real_T *phi,
			real_T *thrust,
			const real_T *xD)
{
...
/*
  ...
  *
  */
void vance_optimization_Update_wrapper(const real_T *x_hat,
			const real_T *theta,
			const real_T *phi,
			const real_T *thrust,
			real_T *xD)
