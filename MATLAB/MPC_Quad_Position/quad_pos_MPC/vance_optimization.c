...
#define S_FUNCTION_NAME vance_optimization
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    vance_optimization_Outputs_wrapper(theta, phi, thrust, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    vance_optimization_Update_wrapper(x_hat, theta, phi, thrust,  xD);
}
