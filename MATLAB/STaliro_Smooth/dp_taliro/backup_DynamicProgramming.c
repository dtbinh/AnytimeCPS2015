...
HyDis hmin(HyDis inp1, HyDis inp2)
{
    ...
    mxArray *array_ptr;
    double C = 100;
    HyDis HDistOut; /*check if these cut it*/
    HDistOut.dl = 1;
    HDistOut.ds = 0;
    ...
    int isSmooth;
    array_ptr = mexGetVariable("global", "taliro_SmoothRob");
    if(array_ptr== NULL)
    {
        mexPrintf("%s\n", "Shitizzle");
        isSmooth = 0;
    ...
    {   
        /*correct way to get value from that shitter*/
        double *mex_val;
        mex_val = (double *)mxGetPr(array_ptr);
        /*mexPrintf("%s%g\n", "Hizzle1 ",*mex_val);*/        
        isSmooth = *mex_val;
        /*mexPrintf("%s%g\n", "Hizzle2 ",isSmooth);*/
        /*mexPrintf("%s%g\n", "does it exist", smooth_operator);*/
