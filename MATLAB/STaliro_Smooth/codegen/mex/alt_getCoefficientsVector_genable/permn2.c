...
static emlrtRSInfo bb_emlrtRSI = { 137, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRSInfo cb_emlrtRSI = { 140, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRSInfo db_emlrtRSI = { 142, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRSInfo eb_emlrtRSI = { 152, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRSInfo fb_emlrtRSI = { 154, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRSInfo gb_emlrtRSI = { 39, "reshape",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/reshape.m" };

static emlrtRSInfo hb_emlrtRSI = { 53, "reshape",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/reshape.m" };

static emlrtRSInfo ib_emlrtRSI = { 100, "reshape",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/reshape.m" };
...
static emlrtRSInfo lb_emlrtRSI = { 101, "applyScalarFunction",
  "/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"
};

static emlrtRSInfo mb_emlrtRSI = { 10, "floor",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/floor.m" };

static emlrtRSInfo nb_emlrtRSI = { 24, "applyScalarFunctionInPlace",
  "/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunctionInPlace.m"
};

static emlrtRSInfo ob_emlrtRSI = { 39, "rem",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/rem.m" };

static emlrtRSInfo pb_emlrtRSI = { 69, "rem",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elfun/rem.m" };

static emlrtRSInfo qb_emlrtRSI = { 146, "applyScalarFunction",
  "/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/applyScalarFunction.m"
};
...
static emlrtRTEInfo k_emlrtRTEI = { 1, 19, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRTEInfo l_emlrtRTEI = { 16, 9, "scalexpAlloc",
  "/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpAlloc.m" };

static emlrtRTEInfo m_emlrtRTEI = { 152, 9, "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m"
};

static emlrtRTEInfo n_emlrtRTEI = { 1, 10, "scalexpAlloc",
  "/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpAlloc.m" };

static emlrtRTEInfo x_emlrtRTEI = { 17, 19, "scalexpAlloc",
  "/usr/local/MATLAB/R2015b/toolbox/eml/eml/+coder/+internal/scalexpAlloc.m" };

static emlrtRTEInfo y_emlrtRTEI = { 63, 15, "reshape",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/elmat/reshape.m" };

static emlrtBCInfo u_emlrtBCI = { -1, -1, 155, 13, "V", "permn2",
  "/home/mlab-retro/Documents/AnytimeCPS2015/MATLAB/STaliro_Smooth/Smooth/wavelet/permn2.m",
  0 };
...
static emlrtRSInfo cc_emlrtRSI = { 20, "error",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/lang/error.m" };
            ...
            emxArray_real_T *M)
{
  ...
  emxInit_real_T(sp, &B, 2, &m_emlrtRTEI, true);
  ...
  if ((V->size[1] == 0) || (N == 0.0)) {
    ...
    if (!!(K != b_K)) {
      ...
      sz_idx_1 = V->size[1];
      for (i5 = 0; i5 < 2; i5++) {
        b_varargin_1[i5] = (uint32_T)V->size[i5];
      }
      ...
      z->size[0] = 1;
      z->size[1] = sz_idx_1;
      emxEnsureCapacity(&c_st, (emxArray__common *)z, i5, (int32_T)sizeof(real_T),
                        &k_emlrtRTEI);
      if (sz_idx_1 > 0) {
        z->data[0] = anew;
        if (sz_idx_1 > 1) {
      ...
      B->size[0] = 1;
      B->size[1] = z->size[1];
      emxEnsureCapacity(&d_st, (emxArray__common *)B, i5, (int32_T)sizeof(real_T),
                        &l_emlrtRTEI);
      if (dimagree(B, z)) {
      } else {
        emlrtErrorWithMessageIdR2012b(&d_st, &x_emlrtRTEI, "MATLAB:dimagree", 0);
      }
...
#pragma omp parallel for \
 ...
 private(c_k)
      ...
      x->size[0] = 1;
      x->size[1] = B->size[1];
      emxEnsureCapacity(&b_st, (emxArray__common *)x, i5, (int32_T)sizeof(real_T),
                        &k_emlrtRTEI);
      k = B->size[0] * B->size[1];
      for (i5 = 0; i5 < k; i5++) {
        x->data[i5] = B->data[i5];
      ...
      z->size[0] = 1;
      z->size[1] = x->size[1];
      emxEnsureCapacity(&b_st, (emxArray__common *)z, i5, (int32_T)sizeof(real_T),
                        &l_emlrtRTEI);
      if (b_dimagree(z, x)) {
      } else {
        emlrtErrorWithMessageIdR2012b(&b_st, &x_emlrtRTEI, "MATLAB:dimagree", 0);
      }
      ...
      if (b_dimagree(z, x)) {
        ...
        emlrtErrorWithMessageIdR2012b(&c_st, &x_emlrtRTEI, "MATLAB:dimagree", 0);
      }
      ...
      for (i5 = 0; i5 < k; i5++) {
        ...
        if (!((sz_idx_1 >= 1) && (sz_idx_1 <= maxdimlen))) {
          emlrtDynamicBoundsCheckR2012b(sz_idx_1, 1, maxdimlen, &u_emlrtBCI, sp);
        }

        M->data[i5] = V->data[sz_idx_1 - 1];
      }
    }
  }
