...
static emlrtRSInfo yb_emlrtRSI = { 11, "prod",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/prod.m" };

static emlrtRSInfo ac_emlrtRSI = { 46, "sumprod",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m" };

static emlrtRSInfo bc_emlrtRSI = { 36, "combine_vector_elements",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/combine_vector_elements.m"
};

static emlrtRTEInfo ab_emlrtRTEI = { 19, 15, "sumprod",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m" };

static emlrtRTEInfo bb_emlrtRTEI = { 39, 9, "sumprod",
  "/usr/local/MATLAB/R2015b/toolbox/eml/lib/matlab/datafun/private/sumprod.m" };
