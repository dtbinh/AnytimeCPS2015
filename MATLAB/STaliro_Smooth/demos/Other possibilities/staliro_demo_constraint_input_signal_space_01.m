...
%   space. In particular, we consider a system with two inputs for which we want  
%   to study its response under two step functions. We would like to impose the 
%   following constraints:
%      * The step for signal 2 should happen after 5 sec of the step for signal 1
...
%
%   We use the Simulink autotransmission benchmark. In terms of application, the 
%   search models hitting the gas pedal, releasing the gas pedal and then 
%   hitting the break.
%
