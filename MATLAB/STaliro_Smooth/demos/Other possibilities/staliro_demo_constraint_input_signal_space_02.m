...
%
% When the "input_space_constrained" option is selected as 0, the sample 
% space is a hypercube which's size is determined by the minimum and
% maximum limit for the states and inputs.
%
% When the "input_space_constrained" option is selected 1, the minimum and
% maximum limit for the states and inputs are still valid and the user can
% further add contraints between different dimensions.
...
% User can define the matrix A and the vector b as "input_A" and "input_b"
...
% We do not add any contraints for the state of the system and so the
...
% input (u2) is [0.8, 1.2]. (The rectange below)
%
%          |
%      2.0 _  ____________                   
%          |  |          |     
...
% It is possible to define contraints between inputs and system statesa and
...
opt.input_space_constrained = 1; %This enables the use of polytopes
...
opt.input_A = [0.4, 0, 0, 0, -1; 
               0, 0.4, 0, 0, -1; 
               0, 0, 0.4, 0, -1; 
               0, 0, 0, 0.4, -1];
opt.input_A = [zeros(4,10), opt.input_A]; %zeros for the states we don't put any constraints on.
opt.input_b = [-0.4; 
               -0.4; 
               -0.4; 
               -0.4];
