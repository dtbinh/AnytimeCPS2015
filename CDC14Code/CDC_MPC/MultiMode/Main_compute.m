...
Res=[64 32 16];%pic is of Res*Res
Tc=0;
% deltas=10^(-3)*[1 2 4]/10;
...
S=Polyhedron([-20 0;-0 20;60 20;80 0;60 -20;0 -20]);
theta=deg2rad(45);
...
% Xset=Polyhedron([40 70;100 50;10 -10;-20 -10;-20 20]);
