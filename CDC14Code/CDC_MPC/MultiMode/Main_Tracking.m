...
for t=1:Tsim %all time
    ...
    for mode=1:No_of_modes %for all modes
        ...
        [controls(mode) costs(mode)] = RMPC(A{mode},A_lift{mode},B_lift{mode},A_lift_prev,B_lift_prev,B1{mode},B2{mode},K{mode},Kx{mode},Acl{mode},F,xLo,u0,Dset,Dset_prev,Xorig,Cdelta{mode},Horizon);
