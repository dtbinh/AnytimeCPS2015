...
We illustrate the approach on a simple linear system, with a reach-avoid type of specification which is common in literature, e.g. in \cite{Saha_acc16}. More extensive case studies are presented in Section \ref{sec:case study}.
