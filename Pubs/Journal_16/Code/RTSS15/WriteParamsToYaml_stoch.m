...
for i=1:numel(deltas)
    ...
    j = i; 
    Zf(i) = FitBoxZf(Cdelta(i),S);
    if(Zf(i).isEmptySet)
        disp('Zf empty')
        pause;       
    end
    for k = 0:H-1  %constraints for all time steps     
