...
\author{Yash Vardhan Pant$^{*}$, Nischal, Max, Houssam Abbas$^{*}$, Megan, Rahul Mangharam% <-this % stops a space
...
\thanks{{\tt\small $\{$yashpant, nkn, mzl, habbas, megan,rahulm$\}$@seas.upenn.edu}}%
}
