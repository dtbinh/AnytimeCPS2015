...
This work formalizes the requirements  as formulas in Metric Temporal Logic (MTL), and 
\ypcomment{revises these requirements at run-time if needed based on the relative importance of the specifications. Add more}.
