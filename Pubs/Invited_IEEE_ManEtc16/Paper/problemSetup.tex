...
\begin{figure}[tb]
\centering
\includegraphics[width=0.49\textwidth]{Figs/vpmpimages/labelled_corridor_2.png}
\caption{Visualization of the Vanishing point algorithm overlaid on the corridor image. The green (upper) dot shows the vanishing point while the red (lower) dot shows the middle point. These are computed from the intersection of the detected corridor guidelines.}
