...
\title{Scalable Control of Large Scale Systems with Metric Temporal Logic specifications}
...
\author{Yash Vardhan Pant, Houssam Abbas, Nischal K.N., Rahul Mangharam% <-this % stops a space
\thanks{Department of Electrical and Systems Engineering, University of Pennsylvania, Philadelphia, PA, USA.}%
\thanks{{\tt\small $\{$yashpant, habbas, nischalkn, rahulm$\}$@seas.upenn.edu}}%
}
...
\cite{Abbas14_MTLDescent} %just here for compilation, remove
