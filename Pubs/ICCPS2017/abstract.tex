\begin{abstract}
 ...
 We demonstrate the use of the smooth robustness to control two quad-rotors in an autonomous air traffic control scenario and temperature control of a building for comfort.
\end{abstract}
