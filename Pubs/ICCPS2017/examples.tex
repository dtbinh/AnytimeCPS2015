...
%\todo[inline]{Replace each Always by $Always_{[0:N-1]}
%$ and make x-axis `Formula horizon $N$. Otherwise this seems to contradict Thm. 3.2. Also explain the $\in \Re^3$ thingy}}
...
\todo[inline]{Y:what is this formula? No RMSE I've ever seen before}
...
\caption{Mean and variance of relative approximation error against formula horizon, evaluated on 1000 randomly generated trajectories for the system in \eqref{eq:PointMass}. Unless noted, the states in the trajectory are in $\mathbb{R}^2$.} 
