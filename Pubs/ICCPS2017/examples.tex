...
\caption{RMSE of robustness approximation error against formula horizon. \todo[inline]{Replace each Always by $Always_{[0:N-1]}
...
\caption{Mean and variance of relative approximation error against formula horizon.\todo[inline]{smae changes as previous fig. All temporal operators must be bounded}}
