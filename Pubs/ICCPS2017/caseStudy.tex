...
To evaluate our approach on systems with complex dynamics, we solve a robustness maximization problem for control of two systems, using three methods (all of which are implemented in MATLAB)
