...
SOP, which is a general purpose technique, results in a robustness which is just $0.02\%$ less than the global optimal value. In the next example, we take a specification which cannot be trivially turned into a quadratic program.
