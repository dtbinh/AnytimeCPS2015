...
Robust MPC (RMPC) has been investigated as a way of handling state estimation errors for linear and nonlinear systems \cite{RichardsH05_RMPC}, but not via feedback linearization.
