...
minimize quad_form(z(:,1),Q) + quad_form(z(:,2),Q) + quad_form(z(:,3),Q) + ...
    ...
    quad_form(z(:,10),Q) + quad_form(z(:,11),Q) + quad_form(z(:,12),Q) + ...
    quad_form(z(:,13),Q) + quad_form(z(:,14),Q) + quad_form(z(:,15),Q) + ...
    quad_form(z(:,16),Q) + quad_form(z(:,17),Q_term) + ...
    ...
    quad_form(v(:,10),R) + quad_form(v(:,11),R) + quad_form(v(:,12),R) + ...
    quad_form(v(:,13),R) + quad_form(v(:,14),R) + quad_form(v(:,15),R) + ...
    quad_form(v(:,16),R) %z'Q'z + v'Rv + z_f'Q_fz'f, for N = 15
