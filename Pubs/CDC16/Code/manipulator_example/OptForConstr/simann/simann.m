function [xopt]=simann(func, x, LB, UB, sa_t, sa_rt, sa_nt, sa_ns,rseed) 
...
%
% things to do: documentation, input and output argument passing, printing, error checking
% 
% See original Fortran code by Bill Goffe for documentation and literature references.
% this code is at 
...
sa_maxeval=12000000;                      %maximum number of function evaluations
