...
%\todo[inline]{details about hexrotor and odroid and the visual odometry. Figure for control/percpetion architecture of hexrotor here, cvxgen based rampc}
...
%We illustrate the foregoing results on the hexrotor example from Section \ref{motivatingExample}.
