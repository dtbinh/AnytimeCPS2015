...
Experiments confirm that the following controller (formulation details in \ref{sec:experiments}) can be run in real-time, and uses a negligible amount of time to compute relative to the estimation delay.
