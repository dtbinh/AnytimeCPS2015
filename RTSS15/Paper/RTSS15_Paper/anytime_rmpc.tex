\hatodoin{Homogenize notation and remove redundancies}
In this appendix we give the detailed mathematical derivation of the results of Section \ref{controlProblem}.
