 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Sat Apr 11 19:03:56 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME vance
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void vance_Outputs_wrapper(real_T *theta,
			real_T *phi,
			real_T *thrust,
			const real_T *xD);
extern void vance_Update_wrapper(const real_T *x_hat,
			const real_T *x_ref,
			const real_T *theta,
			const real_T *phi,
			const real_T *thrust,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    vance_Outputs_wrapper(theta, phi, thrust, xD);
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    vance_Update_wrapper(x_hat, x_ref, theta, phi, thrust,  xD);
}
