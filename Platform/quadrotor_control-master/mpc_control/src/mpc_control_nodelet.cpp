...
class mpcControlNodelet : public nodelet::Nodelet
{
 public:
  mpcControlNodelet() :
...
void mpcControlNodelet::publishTRPYCommand(void)
{
  float ki_yaw = 0;
...
void mpcControlNodelet::position_cmd_callback(const quadrotor_msgs::PositionCommand::ConstPtr &cmd)
{
...
void mpcControlNodelet::odom_callback(const nav_msgs::Odometry::ConstPtr &odom)
{
...
void mpcControlNodelet::onInit(void)
{
 ...
 else
 {
  ...
  odom_sub_ = n.subscribe("odom", 10, &mpcControlNodelet::odom_callback, this,
                          ros::TransportHints().tcpNoDelay());
  position_cmd_sub_ = n.subscribe("position_cmd", 10, &mpcControlNodelet::position_cmd_callback, this,
                                  ros::TransportHints().tcpNoDelay());

  enable_motors_sub_ = n.subscribe("motors", 2, &mpcControlNodelet::enable_motors_callback, this,
                                   ros::TransportHints().tcpNoDelay());
...
PLUGINLIB_EXPORT_CLASS(mpcControlNodelet, nodelet::Nodelet);
