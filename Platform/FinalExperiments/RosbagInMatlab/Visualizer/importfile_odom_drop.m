function slashquadcloud2slashodomdrop = importfile_odom_drop(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SLASHQUADCLOUD2SLASHODOMDROP = IMPORTFILE(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   SLASHQUADCLOUD2SLASHODOMDROP = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   slashquadcloud2slashodomdrop =
%   importfile('_slash_quadcloud2_slash_odom_drop.csv', 2, 2080);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/05/04 14:50:47
...
slashquadcloud2slashodomdrop = cell2mat(raw);
