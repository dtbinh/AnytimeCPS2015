function slashquadcloud2slashodom = importfile_odom(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SLASHQUADCLOUD2SLASHODOM = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   SLASHQUADCLOUD2SLASHODOM = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   slashquadcloud2slashodom =
%   importfile('_slash_quadcloud2_slash_odom.csv', 2, 10587);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/05/04 14:48:38
...
slashquadcloud2slashodom = cell2mat(raw);
